...
def get_generator(model_name:str, model_config):
    generator_name = model_name
    model_config_part = model_config['model']
    if generator_name == 'resnet':
        ...
        model_g = FPNMobileNet(norm_layer=get_norm_layer(norm_type=model_config_part['norm_layer']))
    elif generator_name == 'fpn_inception':
        model_g = FPNInception(norm_layer=get_norm_layer(norm_type=model_config_part['norm_layer']))
    elif generator_name == 'fpn_inception_simple':
        model_g = FPNInceptionSimple(norm_layer=get_norm_layer(norm_type=model_config_part['norm_layer']))
